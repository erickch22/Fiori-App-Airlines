		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Airlines app",
									"targetURL": "#erickappairlineseychapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"erickappairlineseychapp-display": {
								"semanticObject": "erickappairlineseychapp",
								"action": "display",
								"description": "SAP Fiori application.",
								"title": "Airlines app",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=erick.app.airlines.eychapp",
									"url": sap.ui.require.toUrl("erick/app/airlines/eychapp")
								}
							}
						}
					}
